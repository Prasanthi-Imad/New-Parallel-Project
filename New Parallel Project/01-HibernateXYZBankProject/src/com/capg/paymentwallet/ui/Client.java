...
/*
	...
	void fundtransfer() throws Exception {
		...
		accountBean1.addTransaction(wt);

		boolean result = service.fundTransfer(accountBean1, accountBean2,
				transferAmt);

		if (result) {
			System.out.print("\t Transfering Money from Account done");
		} else {
			System.err.print("\t Transfering Money from Account Failed ");
		}
		}
	}
